...
\begin{equation}
    ...
    \omega_{np} = \sqrt{\frec{N_{r}K_{T}I_{o}}{J}}
\end{equation}

Постоянная момента, выраженная из \cite[гл. 4.2, ф-ла 4.52]{Kenio}, при условии линейности характеристики $r = f(\theta)$
...
$\tau = 0,9$ Н$\cdot$м, $I_{o} = 3$ А в (\ref{moment_coeff}) получим
