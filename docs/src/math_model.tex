...
$\tau$ - статический момент удержания, Н*м
...
$\tau = 0,9$ Н*м, $I_{o} = 3$ А в \eqref{moment_coeff} получим
...
Подставляя \eqref{first_approximation_moment_coeff} в \eqref{rotor_natural_frequency}, получим
