...
\begin{enumerate}
    \item Перенацеливания камеры на $q = 20^{\circ}$ за $t_{\text{п}} = 2   \text{с}$
    \item Перенацеливания камеры на $q = 45^{\circ}$ за $t_{\text{п}} = 3   \text{с}$
    \item Перенацеливания камеры на $q = 90^{\circ}$ за $t_{\text{п}} = 4.3 \text{с}$
\end{enumerate}
...
\subsubsection{Перенацеливания, режим 1}
...
\subsubsection{Перенацеливания, режим 2}
...
\subsubsection{Перенацеливания, режим 3}
