...
\subfile{srctechnology/technology/pcb_develop/pcb_technology.tex}
%\subfile{srctechnology/technology/pcb_develop/pcb_design.tex}

\newpage
\section[Список использованной литературы]{}
\begin{thebibliography}{30}
    \subfile{srctechnology/technology/pcb_develop/bibliography}
\end{thebibliography}
