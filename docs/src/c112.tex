...
В результате проведенной работы был построена математическая модель шагового двигателя, проведен
анализ ее ограничений, выполнено сравнение характеристик с моделью шагового двигателя из
\textit{SimPower Systems -> Second Generation -> Motors and Generators -> Hybrid Stepper Motor.}
Характеристики модели построеной нами полностью совпали с характеристиками модели из пакета MatLab.

Проведен анлиз существующих способов управдения шаговым приводом, выбраны 2 оптимальных метода для
режима работы с обратной связью по углу на нагрузке и без обратной связи (аварийный режим работы).

Составлена блоксхема алгоритма работы системы управления с обратной связью, проведен анализ ее
ограничений.
