...
Найден способ определения угла коммутации для текущей скорости и предельной скорости,
ниже которой двигатель гарантировано не выйдет из синхронизма при постоянной
динамической нагрузке.

Принято решение использовать обратную связь по току для управления моментом на
выходе двигателя. Выполнен анализ аппаратного решения предлагаемого TexasInstruments, сформированы
требования к аппаратной части датчиков тока, изучена методика исследования свойств аналогово
