...
\label{sec_math_modeling}

\subsubsection{Модель ``Hybrid Stepper Motor'' из пакета ``SimPower Systems''}

Для проверки работоспособности синтезированных алгоритмов управления и моделирования
процессов, протекающих в системе, воспользуемся пакетом MATLAB.
...
\subsubsection{Результаты моделирования и сравнительный анализ моделей}

Результаты моделирования на двух используемых моделях очень близки, что можно
трактовать как успешную верификацию собственной модели шагового привода.

Моделирование показало, что синтезированные алгоритмы управления значительно
позволяют улучшить качество управления системы и их реализация целесообразна.
