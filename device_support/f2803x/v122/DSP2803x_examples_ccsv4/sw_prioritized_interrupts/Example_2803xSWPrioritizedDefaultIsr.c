...
// Checkin $Date: June 29, 2010   09:55:47 $
//###########################################################################
//
// FILE:    Example_2803xSWPrioritizedDefaultIsr.c
//
// TITLE:   DSP2803x Device Default Software Prioritized Interrupt Service Routines.
//
//          This file is based on the standard DSP2803x_SWPrioritizedDefaultIsr.c
...
#if (G64PL != 0)
interrupt void SPITXINTB_ISR(void)     // SPI-A
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER6.all;
	IER |= M_INT6;
