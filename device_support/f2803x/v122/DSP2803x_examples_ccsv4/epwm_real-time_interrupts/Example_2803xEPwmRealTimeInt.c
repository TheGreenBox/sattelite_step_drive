...
// Checkin $Date: August 24, 2010   09:54:48 $
//###########################################################################
//
// FILE:    Example_2803xEPwmRealTimeInt.c
//
// TITLE:   DSP2803x ePWM Real-Time Interrupt example.
//
// ASSUMPTIONS:
//
...
//
//	  ControlCard LED2 toggled in main loop
//	  ControlCard LED3 toggled in ePWM1 Timer Interrupt
//
...
// Step 6. IDLE loop. Just sit and loop forever (optional):
   ...
   {
       asm("          NOP");
       for(i=1;i<=100;i++) GpioDataRegs.GPATOGGLE.bit.GPIO31 = 1;	//toggle LED2 on the controlCARD
   }
}
