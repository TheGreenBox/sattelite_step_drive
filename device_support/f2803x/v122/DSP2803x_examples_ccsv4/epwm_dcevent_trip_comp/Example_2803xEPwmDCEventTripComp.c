...
// Checkin $Date: June 29, 2010   09:54:45 $
//###########################################################################
//
// FILE:    Example_2803xEpwmTripZoneComp.c
//
...
//
//    Initially make voltage on pin COMP2A greater than COMP2B if using dual pin compare; else make internal DAC output lower than V on COMP2A
//
//    During the test, monitor ePWM1 outputs on a scope 
//    increase voltage on inverting side of comparator(either through COMP2B pin or internal DAC setting) to trigger
...
// InitPeripherals();  // Not required for this example
   ...
   Comp1Regs.COMPCTL.bit.COMPSOURCE = 1;                 // Connect the inverting input to pin COMP2B
////////////////Uncomment following 2 lines to use DAC instead of pin COMP2B //////////////////
